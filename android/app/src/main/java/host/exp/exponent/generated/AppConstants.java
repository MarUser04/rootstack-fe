...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@useche_dev/rootstack-fe";
  public static final String SHELL_APP_SCHEME = "exp4a8bb08c54ed446388aa4bc03aee1db5";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@useche_dev/rootstack-fe", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40useche_dev%2Frootstack-fe%2F1.0.0%2F801be351f8afc5be6c9750edbe084909-32.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
